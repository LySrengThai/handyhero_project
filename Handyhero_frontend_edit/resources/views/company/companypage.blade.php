            ...
            <div>
                ...
                <div class="my-4">
                    ...
                    <p style="font-weight:600;" class="h5">Phone number:
                        {{ substr_replace($company_data->company_number, '-', 3, 0) }}</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill"
                                        value="{{ $company_data->company_name }}" readonly>
                                </div>

                                <div class="col-sm-6">
                                    <label for="sercategory">Category</label>
                                    <select class="form-control rounded-pill" aria-label="Default select example"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill" id="Price"
                                        placeholder="Price Start From" name="serviceprice" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    <textarea class="form-control rounded" id="desc" rows="10" name="serdescription"
                    ...
                    <div style="color: #203D4A;">
                        ...
                        <div class="table-responsive-lg">
                            <table class="table table-hover">
                                <thead class="align-item-center text-center text-white"
                                    style="background-color: #34868C;">
                                    <tr>
                                    ...
                                    @foreach ($bookings as $book)
                                        <tr>
                                            ...
                                            <td><img src="https://static.vecteezy.com/system/resources/previews/008/442/086/original/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg"
                                                    width="20px"
                                                    class="rounded-circle mx-2">{{ $book->user_fname }}&#160;{{ $book->user_lname }}
                                            </td>
                                            <td>{{ $book->user_number }}</td>
                                            <td class="text-muted">{{ $book->user_email }}</td>
                                            <td class="text-muted">{{ $book->user_address }}</td>
                                            ...
                                            <td>
                                                ...
                                                <a href="#" style="color: grey; margin-left: 5%;"><i
                                                        class="fa-solid fa-circle-check fa-lg"></i></a>
                                            </td>
                            ...
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control rounded-pill" id="CompanyName"
                                        placeholder="company name" value="{{ $company_data->company_name }}" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-sm-6">
                                    <input type="email" class="form-control rounded-pill" id="Email"
                                        placeholder="Email" value="{{ $company_data->company_email }}" required>
                                    <div class="invalid-feedback">
