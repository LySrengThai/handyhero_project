            ...
            <div class="col-7 d-flex ">
                <div class="b_btn">
                    <button class="btn btn-sm btn-back" type="submit"
                        onclick="location.href = '/receipt_info'">Back</button>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ $receipt_detail[0]->receipt_date }}</p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ $receipt_detail[0]->user_fname }} {{ $receipt_detail[0]->user_lname }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ substr_replace($receipt_detail[0]->user_number, '-', 3, 0) }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ $receipt_detail[0]->user_email }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end">
                                <p class="mb-0 text-right">{{ $receipt_detail[0]->user_address }}</p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ $receipt_detail[0]->company_name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ $receipt_detail[0]->service_name }}</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>{{ $receipt_detail[0]->booking_date }}</p>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-end justify-content-end">
                                <p>៛{{ number_format($receipt_detail[0]->receipt_price) }}
                                <p>
                            </div>
                        </div>
