    ...
    <div class="container-fluid pt-3">
        ...
        <div class="row px-5">
                            ...
                            <table class="table table-bordered table-striped table-hover m-0" style="width: 100%;">
                                ...
                                <tbody class="table-body text-center">
                                    @foreach ($user as $detail)
                                        <tr>
                                            <td scope="col" style="vertical-align: middle;">{{ $detail->user_fname }} {{ $detail->user_lname }}</td>
                                            <td scope="col" style="vertical-align: middle;">
                                                {{ \Carbon\Carbon::parse($detail->created_at)->diffForHumans() }}</td>
                                        </tr>
                                    @endforeach
            ...
            <div class="col-12 col-sm-6 pb-4">
                <div class="card">
                    <div class="card-head bg-light text-white py-3">
                        <div class="d-flex justify-content-between px-3 text-dark">
                            <h5 class="text-truncate">Latest Company</h5>
                            <a href="/company_info" class="text-dark">View</a>
                        </div>
                    </div>
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-primiary table-hover m-0" style="width: 100%;">
                                <thead class="table-head text-center text-white" style="background-color:#0e638b;">
                                    <tr>
                                ...
                                <tbody class="table-body text-center">
                                    @foreach ($company as $detail)
                                        <tr>
                                            <td scope="col" style="vertical-align: middle;">{{ $detail->company_name }}</td>
                                            <td scope="col" style="vertical-align: middle;">
                                                {{ \Carbon\Carbon::parse($detail->created_at)->diffForHumans() }}</td>
                                        </tr>
                                    @endforeach
