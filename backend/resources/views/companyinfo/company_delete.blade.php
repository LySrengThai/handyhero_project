...
@section('content')
    <div class="home-content">
        ...
        <div class="col-7" style="font-size: 32px;">
            <h2 class="text-white text-truncate">{{ $company_detail[0]->company_name }} Delete</h2>
        </div>
    </div><br>
            ...
            <div class="col-md-4 text-center">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a href="/companydelete/{{ $company_detail[0]->company_id }}" class="btn btn-sm btn-danger">Yes</a>
                    </div>
                </div>
            </div>
