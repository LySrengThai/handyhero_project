...
class dashboardcontroller extends Controller
{
    ...
    public function dashboardIndex()
    {
        ...
        $db_company = DB::table('company_detail')->latest()->limit(7)->get();


        return view('dashboard', compact('data', 'totaluser', 'totalcompany', 'totalservice', 'thisMonthBook'), ['user' => $db_user, 'company' => $db_company]);
    }
}
